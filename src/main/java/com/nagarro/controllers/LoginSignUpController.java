...
/**
 * The class LoginSignupController represents a controller which is called when a user
 * registers or login to website. It is having two methods one for login and
 * other for regstration
 * 
 * 
 *
 */
